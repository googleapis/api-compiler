 ...
 * A feature:
 * <ul>
 * <li>has a name composed of '/' separated parts, starting with a namespace identifier</li>
 * <li>may be enabled or disabled by default at a particular config version</li>
 * <li>only be available at a limited range of config versions</li>
 * <li>may have child features that are enabled when the parent is enabled</li>
 * </ul>
 */
public class Feature {
   ...
   * as well.
   */
  void accumulate(Set<String> enabled, boolean remove,
